 ...
 */
public class WeiXinServletImpl implements ICustomerServlet{

    public static Logger logger = Logger.getLogger(WeiXinServletImpl.class);
    ...
    public HandleResultBo sendModelMessage(String tokenVal,TemplateMsgBo templateMsgBo){
        ...
        HttpURLConnection templateMsgConn = doServletPost(UrlConfig_wx.getSendTemplateMsgUrl(tokenVal), JSONObject.toJSONString(msgBo));
        if (templateMsgConn != null) {
            String templateMsgResultStr = doGetServerResult(templateMsgConn);
    ...
    public UserListResultBo getUserList(String tokenVal){
        ...
        HttpURLConnection userListConn = doServletPost(UrlConfig_wx.getUserListUrl(tokenVal), "");
        if (userListConn!=null) {
            String userListResultStr = doGetServerResult(userListConn);
