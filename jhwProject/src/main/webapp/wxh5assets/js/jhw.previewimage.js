(function($, window) {
	...
	proto.init = function() {
		...
		this.deleteBtn = this.element.querySelector($.classSelector('.jhw-preview-delete'));
		if (options.footer) {
	...
	proto.initEvent = function() {
		...
		/*this.deleteBtn.addEventListener('tap', function() {
			console.log(nowIndex);
		});*/
		$(document.body).on('tap', '.jhw-preview-delete', function() {
			self.loader.removeEventListener('tap', laterCloseEvent);
				self.scroller.removeEventListener('tap', laterCloseEvent);
				self.close();
				//console.log(nowIndex);
